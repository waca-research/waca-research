...
void log_data(long long *values, int tid, long long microseconds, long long timestamp){
		...
		fprintf(fp,"%s,%s,%s,%s,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%s%s%s%s%s%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%d,%lld",
					A7_POWER,A15_POWER,MEM_POWER,GPU_POWER,
					microseconds,
					values[0],values[1],values[2], values[3], values[4], values[5],
					TEMP_CPU0_TEMP,TEMP_CPU1_TEMP,TEMP_CPU2_TEMP,TEMP_CPU3_TEMP,TEMP_CPU4_TEMP,
					CPU0_FREQ,CPU1_FREQ,CPU2_FREQ,CPU3_FREQ,CPU4_FREQ,CPU5_FREQ,CPU6_FREQ,CPU7_FREQ, 
